...
//enum type för att representera olika pokemon typer
enum Type
{
    NORMAL,
    FIRE,
...
//innehåller en statisk matris som representerar skademultiplikatorerna mellan olika typer.
...
struct TypeChart
{
    ...
    //används för att hämta skademultiplikatorn för en given attack- och försvarstyp.
